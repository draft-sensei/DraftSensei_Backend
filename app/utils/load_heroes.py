"""
Script to load hero data from final_heroes.json into database
"""
        ...
        for hero_data in heroes_data:
            try:
                ...
                if existing_hero:
                    ...
                    # Create new hero
                    new_hero = Hero(name=name, image=hero_data.get("image", ""))
                ...
                print(
                    f"  ✗ Error processing {hero_data.get('name', 'Unknown')}: {str(e)}"
                )
                error_count += 1
                continue
